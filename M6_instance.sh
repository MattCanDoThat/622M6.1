...
while true; do
  ...
  # Render current step's animated bar (overwrites current line)
  frame="${frames:i%4:1}"
  printf "\r\033[2K"
  ...
  # Status line on the line below (move down, print, move back up)
  printf "\n\r\033[2K"
  printf "  ${C_DIM}Status: %s${C_RESET}" "$CurrentStatus"
  printf "\033[1A"
